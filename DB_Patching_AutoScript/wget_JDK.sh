...
then
 ...
 $WGET  --load-cookies="$COOKIE_FILE" "https://updates.oracle.com/Orion/Services/download/p37542054_190000_Linux-x86-64.zip?aru=26871712&patch_file=p37542054_190000_Linux-x86-64.zip" -O "$OUTPUT_DIR/p37542054_190000_Linux-x86-64.zip"   >> "$LOGFILE" 2>&1 
