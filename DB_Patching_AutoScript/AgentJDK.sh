...
then
 ...
 $WGET  --load-cookies="$COOKIE_FILE" "https://updates.oracle.com/Orion/Services/download/p37766455_180451_Linux-x86-64.zip?aru=26886247&patch_file=p37766455_180451_Linux-x86-64.zip" -O "$OUTPUT_DIR/p37766455_180451_Linux-x86-64.zip"   >> "$LOGFILE" 2>&1 
