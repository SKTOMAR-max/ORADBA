...
then
 ...
 $WGET  --load-cookies="$COOKIE_FILE" "https://updates.oracle.com/Orion/Services/download/p37591483_190000_Linux-x86-64.zip?aru=27121330&patch_file=p37591483_190000_Linux-x86-64.zip" -O "$OUTPUT_DIR/p37591483_190000_Linux-x86-64.zip"   >> "$LOGFILE" 2>&1 
